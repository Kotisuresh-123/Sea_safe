    ...
    >
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-3">
          <button className="text-sm font-medium text-white/85 hover:text-white px-4 py-2 rounded-lg transition-colors">
            Sign In
          </button>
          <button className="btn-ripple text-sm font-semibold text-bgdark bg-gradient-to-r from-secondary to-accent px-5 py-2.5 rounded-lg shadow-card hover:brightness-110 transition-all">
            Get Started
          </button>
        </div>
          ...
          >
            <ul className="flex flex-col p-3">
              ...
              <div className="flex flex-col gap-2 p-3 pt-2">
                <button className="w-full text-sm font-medium text-white border border-white/20 py-2.5 rounded-lg">
                  Sign In
                </button>
                <button className="w-full text-sm font-semibold text-bgdark bg-gradient-to-r from-secondary to-accent py-2.5 rounded-lg">
                  Get Started
                </button>
              </div>
            </ul>
